...
public enum ItemType {
  ...
  WCS("WCS", URL, Pattern.compile(".+service=WCS.*$|.+/wcs$|.+WCS.axd.*$", Pattern.CASE_INSENSITIVE), null),
  WMS("WMS", URL, Pattern.compile(".+service=WMS.*$|.+/wms$|.+WMS.axd.*$", Pattern.CASE_INSENSITIVE), null),
  WFS("WFS", URL, Pattern.compile(".+service=WFS.*$|.+/wfs$|.+WFS.axd.*$", Pattern.CASE_INSENSITIVE), null),
  WPS("WPS", URL),
  WMTS("WMTS", URL, Pattern.compile(".+service=WMTS.*$|.+/wmts$|.+WMTS.axd.*$", Pattern.CASE_INSENSITIVE), null),
