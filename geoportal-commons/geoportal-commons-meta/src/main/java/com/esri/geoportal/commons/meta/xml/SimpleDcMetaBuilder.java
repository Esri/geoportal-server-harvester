...
/**
 * Simple DC meta builder.
 */
public class SimpleDcMetaBuilder extends BaseXmlMetaBuilder {
   ...
   */
  public SimpleDcMetaBuilder() throws IOException, TransformerConfigurationException {
    super("meta/encodedc.xslt");
  }
