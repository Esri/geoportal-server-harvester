...
xmlns:gml="http://www.opengis.net/gml/3.2" 
	...
	exclude-result-prefixes="mdb cat gfc cit gcx gex lan srv mas mcc mco mda mds mdt mex mmi mpc mrc mrd mri mrl mrs msr mdq mac gco gml t xsl esri xsl xsi xlink">
