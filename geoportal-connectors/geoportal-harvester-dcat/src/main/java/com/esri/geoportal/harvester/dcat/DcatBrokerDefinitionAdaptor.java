...
/**
 * DCAT broker definition adaptor.
 */
public class DcatBrokerDefinitionAdaptor extends BrokerDefinitionAdaptor {
   ...
   */
  public DcatBrokerDefinitionAdaptor(EntityDefinition def) throws InvalidDefinitionException {
    super(def);
    this.botsAdaptor = new BotsBrokerDefinitionAdaptor(def);
    if (StringUtils.trimToEmpty(def.getType()).isEmpty()) {
      def.setType(DcatConnector.TYPE);
