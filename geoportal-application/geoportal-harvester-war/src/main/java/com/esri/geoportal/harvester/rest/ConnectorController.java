...
public class ConnectorController {
  ...
  public DataConnectorTemplate[] listSourceTypes() {
    return engine.getInboundConnectorTemplates().toArray(new DataConnectorTemplate[0]);
  }
  ...
  public DataConnectorTemplate[] listDestinationTypes() {
    return engine.getOutboundConnectorTemplates().toArray(new DataConnectorTemplate[0]);
  }
  ...
  public DataConnectorTemplate getSource(@PathVariable String name) {
  ...
  public DataConnectorTemplate getDestination(@PathVariable String name) {
