...
/**
 * Data adaptor template.
 * <p>
 * Adaptor template is used to generate information sufficient to build form UI.
 */
public class DataAdaptorTemplate {
   ...
   */
  public DataAdaptorTemplate(String name, String label, List<Argument> arguments) {
    this.name = name;
    this.label = label;
