...
/**
 * Folder data publisher.
 */
public class FolderDataDestination implements DataDestination<String> {
   ...
   */
  public FolderDataDestination(FolderAttributesAdaptor attributes) {
